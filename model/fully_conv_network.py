# This file was adapted from the file found here:
...
class CoarseFCN8Generator(nn.Module):
    def __init__(self, input_channel,output_channel, use_cuda=True, device_ids=None):
        ...
        self.n_classes = input_channel
        self.loss = functools.partial(cross_entropy2d, size_average=False)

        self.conv_block1 = nn.Sequential(
            nn.Conv2d(input_channel + 2, 64, 3, padding=100),
    ...
    def forward(self, x, mask):
        ...
        x1 = torch.cat([x, ones, mask], dim=1)
        
        conv1 = self.conv_block1(x1)
